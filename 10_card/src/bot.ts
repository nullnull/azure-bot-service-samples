...
const ASK_DATE_TIME_DIALOG_ID = "ASK_DATE_TIME_DIALOG_ID";
...
const askDateTimeStep: WaterfallStep = async (step) => {
  return await step.prompt(ASK_DATE_TIME_DIALOG_ID, "日時を入力してね");
};
...
export class Bot extends TeamsActivityHandler {
  ...
  constructor() {
    ...
    dialogSet.add(new DateTimePrompt(ASK_DATE_TIME_DIALOG_ID));
    dialogSet.add(
